...
# Title: Simple Carnival Import Images as Planes
# Author: Jeff Boller (http://3d.simplecarnival.com), Florian Meyer (tstscr), mont29, matali
# Description: Identical to Blender's included Import Images as Planes script, except that it imports at a rotation of x=90. That way, the plane will be 
#              facing the camera on the Simple Carnival Animation Template.
# Requirements: Blender 2.69+ (http://www.blender.org)

###############################################################################################################################################################
# VERSION HISTORY
#
# 1.9.2 - 11/23/14 - Identical to Blender's included Import Images as Planes script, except that it imports at a rotation of x=90. That way, the plane will be
#                    facing the camera on the Simple Carnival Animation Template.
# 1.9.3 - 3/19/15 - First public release on GitHub.
###############################################################################################################################################################

bl_info = {
    "name": "Simple Carnival Import Images as Planes",
    "author": "Jeff Boller, Florian Meyer (tstscr), mont29, matali",
    "version": (1, 9, 3),
    "blender": (2, 69, 0),
    "location": "File > Import > Images as Planes or Add > Mesh > Images as Planes",
    "description": "Identical to Blender's included Import Images as Planes script, except that it imports at a rotation of x=90. That way, the plane will be facing the camera on the Simple Carnival Animation Template.",
    "warning": "",
    "wiki_url": "http://wiki.blender.org/index.php/Extensions:2.6/Py/"
                "Scripts/Add_Mesh/Planes_from_Images"
                "3d.simplecarnival.com",
